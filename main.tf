...
# Launch RDS instance
module "rds" {
  source = "git@github.com:pdnt/terraform-modules.git//rds"
  # rds variables
  project_name                 = local.project_name
  environment                  = local.environment
  private_data_subnet_az1_id   = module.vpc.private_data_subnet_az1_id
...
module "ssl_certificate" {
  source            = "git@github.com:pdnt/terraform-modules.git//acm"
...
module "application_load_balancer" {
  source                = "git@github.com:pdnt/terraform-modules.git//alb"
  project_name          = local.project_name
  environment           = local.environment
...
module "ecs" {
  source                       = "git@github.com:pdnt/terraform-modules.git//ecs"
  project_name                 = local.project_name
  environment                  = local.environment
  ...
  region                       = local.region
  private_app_subnet_az1_id    = module.vpc.private_app_subnet_az1_id
  private_app_subnet_az2_id    = module.vpc.private_app_subnet_az1_id
